...
/*     const createTHACOposicion2019 = await prisma.oposicion.create({
        data: {
            name: "THAC",
            year: 2019,
            numPlazas: 300,
    ...
    const createTHACOposicion2020 = await prisma.oposicion.create({
        data: {
            name: "THAC",
            year: 2020,
            numPlazas: 350,
...
/* 
    // Creamos opositor que ha aprobado oposicion todos los ejercicios.
    const createOpositor1 = await prisma.opositor.create({
        data: {
            name: "aegos",
            nif: "***2828***",
            oposiciones: {
    ...
    const createOpositor2 = await prisma.opositor.create({
        data: {
            name: "charo",
            nif: "***2228***",
            oposiciones: {
